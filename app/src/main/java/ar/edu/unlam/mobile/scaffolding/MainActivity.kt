    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(NavigationRoutes.HomeScreen.route) {
                HomeScreen(
                    modifier = Modifier.padding(paddingValue),
                    onError = { message ->LaunchedEffect(message) {
...
fun MainScreen() {
    ...
    Scaffold(
        // Mostrar `BottomBar` solo si el destino actual es `HomeScreen`
        bottomBar = {
            if (currentDestination?.route == NavigationRoutes.HomeScreen) {
                BottomBar(controller = navController)
            }
        },
        snackbarHost = { SnackbarHost(hostState = snackbarHostState) }
        ...
        NavHost(
            navController = navController,
            startDestination = NavigationRoutes.LoginScreen
        ) {
                ...
                LoginScreen(
                    ...
                    onNavigateToHomeScreen = {
                        navController.navigate(NavigationRoutes.HomeScreen) {
                            popUpTo(NavigationRoutes.LoginScreen) { inclusive = true }
                            launchSingleTop = true
                        }
                    },
                    modifier = Modifier.padding(paddingValue)
            ...
            composable(NavigationRoutes.RegisterScreen) {
                RegisterScreen(
                    onNavigateToHomeScreen = {
                        navController.navigate(NavigationRoutes.HomeScreen) {
                            popUpTo(NavigationRoutes.RegisterScreen) { inclusive = true }
                            launchSingleTop = true
                        }
                    },
                    modifier = Modifier.padding(paddingValue)
            ...
            composable(NavigationRoutes.CrearteTuitScreen) {
                CrearteTuitScreen(
                    navController = navController
                )
            }
...
import ar.edu.unlam.mobile.scaffolding.ui.screens.TuitScreens.CreateTuitScreen
...
fun MainScreen() {
    ...
    Scaffold(
        ...
        NavHost(
            navController = navController,
            startDestination = NavigationRoutes.LoginScreen.route // Comienza en LoginScreen
        ) {
            composable(NavigationRoutes.LoginScreen.route) {
                LoginScreen(
                    onNavigateToRegisterScreen = {
            ...
            composable(NavigationRoutes.CreateTuitScreen.route) {
                CreateTuitScreen(navController = navController)
            }
        }
    }
}
