...
object NetworkModule {
    ...
    fun provideTuitRepository(
        ...
        tuitDao: TuitDao,
    ): TuitRepository = TuitRepositoryImpl(apiService, tuitDao)

    @Provides
    fun provideUserRepository(
        apiService: ApiService,
        tokenManager: TokenManager,
    ): UserRepository = UserRepositoryImpl(apiService, tokenManager)

    @Provides
    fun provideProfileRepository(
        apiService: ApiService,
        tokenManager: TokenManager,
    ): ProfileRepository = ProfileRepositoryImpl(apiService, tokenManager)
}
